...
def upgrade() -> None:
    ...
    sa.Column('additional_documents', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
    ...
    sa.Column('incoming_grid_percent', sa.Numeric(precision=5, scale=2), nullable=True),
    sa.Column('agent_commission_given_percent', sa.Numeric(precision=5, scale=2), nullable=True),
    sa.Column('extra_grid', sa.Numeric(precision=5, scale=2), nullable=True),
    sa.Column('commissionable_premium', sa.Numeric(precision=15, scale=2), nullable=True),
    sa.Column('payment_by', sa.String(length=50), nullable=True),
    sa.Column('payment_method', sa.String(length=100), nullable=True),
    sa.Column('payout_on', sa.String(length=20), nullable=True),
    sa.Column('agent_extra_percent', sa.Numeric(precision=5, scale=2), nullable=True),
    ...
    sa.Column('receivable_from_broker', sa.Numeric(precision=15, scale=2), nullable=True),
    sa.Column('extra_amount_receivable_from_broker', sa.Numeric(precision=15, scale=2), nullable=True),
    sa.Column('total_receivable_from_broker', sa.Numeric(precision=15, scale=2), nullable=True),
    sa.Column('total_receivable_from_broker_with_gst', sa.Numeric(precision=15, scale=2), nullable=True),
    ...
    sa.Column('agent_extra_amount', sa.Numeric(precision=15, scale=2), nullable=True),
    sa.Column('total_agent_po_amt', sa.Numeric(precision=15, scale=2), nullable=True),
    sa.Column('claimed_by', sa.String(length=200), nullable=True),
    sa.Column('already_given_to_agent', sa.Numeric(precision=15, scale=2), nullable=True),
