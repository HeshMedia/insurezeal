...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_brokers_broker_code"), "brokers", ["broker_code"], unique=True
    )
    ...
    op.create_index(
        op.f("ix_insurers_insurer_code"), "insurers", ["insurer_code"], unique=True
    )
    op.create_table(
        "users",
    ...
    op.create_index(
        op.f("ix_admin_child_ids_child_id"),
        "admin_child_ids",
        ["child_id"],
        unique=True,
    )
    op.create_index(
        op.f("ix_admin_child_ids_id"), "admin_child_ids", ["id"], unique=False
    )
    op.create_table(
        "child_id_requests",
        sa.Column("id", sa.UUID(), nullable=False),
    ...
    op.create_index(
        op.f("ix_child_id_requests_child_id"),
        "child_id_requests",
        ["child_id"],
        unique=True,
    )
    op.create_index(
        op.f("ix_child_id_requests_user_id"),
        "child_id_requests",
        ["user_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column(
            "po_paid_to_agent", sa.Numeric(precision=15, scale=2), nullable=False
        ),
        sa.Column("created_by", sa.UUID(), nullable=True),
        sa.Column(
            "created_at",
    ...
    op.create_index(
        "idx_cutpay_agent_config_agent_code",
        "cutpay_agent_configs",
        ["agent_code"],
        unique=False,
    )
    op.create_index(
        "idx_cutpay_agent_config_date", "cutpay_agent_configs", ["date"], unique=False
    )
    op.create_index(
        op.f("ix_cutpay_agent_configs_agent_code"),
        "cutpay_agent_configs",
        ["agent_code"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column(
            "processing_time_seconds", sa.Numeric(precision=10, scale=3), nullable=False
        ),
        sa.Column(
            "data_variance_percentage", sa.Numeric(precision=5, scale=2), nullable=False
        ),
        sa.Column(
            "coverage_percentage", sa.Numeric(precision=5, scale=2), nullable=False
        ),
        sa.Column(
            "field_changes", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        sa.Column(
            "error_details", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        sa.Column(
            "change_details", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
    ...
    op.create_index(
        "idx_reconciliation_reports_insurer",
        "reconciliation_reports",
        ["insurer_name"],
        unique=False,
    )
    op.create_index(
        "idx_reconciliation_reports_processed_by",
        "reconciliation_reports",
        ["processed_by"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_reconciliation_reports_insurer_name"),
        "reconciliation_reports",
        ["insurer_name"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_user_profiles_agent_code"),
        "user_profiles",
        ["agent_code"],
        unique=True,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        "idx_reconciliation_reports_processed_by", table_name="reconciliation_reports"
    )
    op.drop_index(
        "idx_reconciliation_reports_insurer", table_name="reconciliation_reports"
    )
    op.drop_index(
        "idx_reconciliation_reports_created_at", table_name="reconciliation_reports"
    )
    op.drop_table("reconciliation_reports")
    op.drop_index(
        op.f("ix_cutpay_agent_configs_agent_code"), table_name="cutpay_agent_configs"
    )
    op.drop_index("idx_cutpay_agent_config_date", table_name="cutpay_agent_configs")
    op.drop_index(
        "idx_cutpay_agent_config_agent_code", table_name="cutpay_agent_configs"
    )
