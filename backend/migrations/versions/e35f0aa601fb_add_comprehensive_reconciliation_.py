...
def upgrade() -> None:
    ...
    op.add_column(
        "reconciliation_reports",
        sa.Column("new_records_added", sa.Integer(), nullable=True),
    )
    # Update existing records to have a default value of 0
    op.execute(
        "UPDATE reconciliation_reports SET new_records_added = 0 WHERE new_records_added IS NULL"
    )
    ...
    op.add_column(
        "reconciliation_reports",
        sa.Column(
            "total_receivable_from_broker_variations", sa.Integer(), nullable=True
        ),
    )
    op.add_column(
        "reconciliation_reports",
    ...
    op.add_column(
        "reconciliation_reports",
        sa.Column(
            "as_per_broker_po_percentage_variations", sa.Integer(), nullable=True
        ),
    )
    op.add_column(
        "reconciliation_reports",
    ...
    op.add_column(
        "reconciliation_reports",
        sa.Column(
            "actual_agent_po_percentage_2_variations", sa.Integer(), nullable=True
        ),
    )
    op.add_column(
        "reconciliation_reports",
        sa.Column(
            "as_per_agent_payout_percentage_variations", sa.Integer(), nullable=True
        ),
    )
    op.add_column(
        "reconciliation_reports",
    ...
    op.drop_index(
        "idx_reconciliation_reports_status", table_name="reconciliation_reports"
    )
    op.create_index(
        "idx_reconciliation_reports_insurer_code",
        "reconciliation_reports",
        ["insurer_code"],
        unique=False,
    )
    op.create_index(
        op.f("ix_reconciliation_reports_insurer_code"),
        "reconciliation_reports",
        ["insurer_code"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.add_column(
        "reconciliation_reports",
        sa.Column(
            "total_records_skipped", sa.INTEGER(), autoincrement=False, nullable=False
        ),
    )
    op.add_column(
        "reconciliation_reports",
        sa.Column(
            "report_type", sa.VARCHAR(length=50), autoincrement=False, nullable=False
        ),
    )
    op.add_column(
        "reconciliation_reports",
    ...
    op.add_column(
        "reconciliation_reports",
        sa.Column(
            "total_records_added", sa.INTEGER(), autoincrement=False, nullable=False
        ),
    )
    op.add_column(
        "reconciliation_reports",
    ...
    op.drop_index(
        op.f("ix_reconciliation_reports_insurer_code"),
        table_name="reconciliation_reports",
    )
    op.drop_index(
        "idx_reconciliation_reports_insurer_code", table_name="reconciliation_reports"
    )
    op.create_index(
    ...
    op.drop_column(
        "reconciliation_reports", "as_per_agent_payout_percentage_variations"
    )
