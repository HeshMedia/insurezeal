...
def upgrade() -> None:
    ...
    # Drop columns
    columns_to_drop = [
        'instance_id', 'phone_change_sent_at', 'email_change_sent_at', 'last_sign_in_at',
        'is_anonymous', 'raw_app_meta_data', 'email_change', 'reauthentication_token',
        'reauthentication_sent_at', 'invited_at', 'email_change_token_current',
        'recovery_token', 'email_change_confirm_status', 'banned_until',
        'email_confirmed_at', 'phone_change', 'phone_change_token',
        'email_change_token_new', 'is_sso_user', 'encrypted_password',
        'recovery_sent_at', 'confirmation_token', 'aud', 'raw_user_meta_data',
        'is_super_admin', 'phone_confirmed_at', 'confirmation_sent_at'
    ]
