...
def upgrade() -> None:
    ...
    op.add_column(
        "cut_pay", sa.Column("invoice_number", sa.String(length=100), nullable=True)
    )
    op.add_column(
        "cut_pay",
        sa.Column(
            "po_diff_broker_percent", sa.Numeric(precision=5, scale=2), nullable=True
        ),
    )
    op.add_column(
        "cut_pay",
        sa.Column(
            "po_diff_broker_amt", sa.Numeric(precision=15, scale=2), nullable=True
        ),
    )
    op.add_column(
        "cut_pay",
        sa.Column(
            "agent_payout_percent", sa.Numeric(precision=5, scale=2), nullable=True
        ),
    )
    op.add_column(
        "cut_pay",
        sa.Column(
            "agent_payout_amount", sa.Numeric(precision=15, scale=2), nullable=True
        ),
    )
    op.add_column(
        "cut_pay",
        sa.Column(
            "po_diff_agent_percent", sa.Numeric(precision=5, scale=2), nullable=True
        ),
    )
    op.add_column(
        "cut_pay",
        sa.Column(
            "po_diff_agent_amt", sa.Numeric(precision=15, scale=2), nullable=True
        ),
    )
    ...
    op.add_column(
        "policies", sa.Column("invoice_number", sa.String(length=100), nullable=True)
    )
