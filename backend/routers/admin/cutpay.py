...
async def upload_policy_document(
    ...
    try:
        ...
        logger.info(
            f"🔵 PRESIGNED: Processing document_type='{document_type}' with type='{type}' for policy ID '{policy_id}' (CutPay ID {cutpay_id})"
        )
        ...
        logger.info(
            f"Generated presigned URL for policy ID '{policy_id}' (CutPay ID {cutpay_id}), key: {key}"
        )
