"""
Administrative Helper Functions for Insurezeal Backend API.

This module provides comprehensive helper functions for administrative operations
across the insurance platform. It handles complex business logic for agent
management, statistics calculation, child ID request processing, and system
administration tasks that require elevated permissions.

Key Features:
- Agent profile management and statistics calculation
- Child ID request lifecycle management (creation, approval, rejection)
- Google Sheets integration for administrative data sync
- User document and verification status management
- Database operations with proper error handling
- Supabase admin client integration for user management

Business Logic:
- Agent onboarding and profile completion tracking
- Document verification and approval workflows
- Platform usage statistics and reporting
- Child ID assignment and management
- Data synchronization between platform and external systems
...
class AdminHelpers:
    """
    Comprehensive helper class for administrative operations and business logic.

    This class encapsulates complex administrative functionality including agent
    management, statistics calculation, child ID processing, and system administration.
    All methods require appropriate admin-level permissions and handle sensitive
    operations with proper error handling and logging.

    Key Responsibilities:
        - Agent profile statistics and management
        - Child ID request processing and approval workflows
        - User document verification and status updates
        - Platform usage statistics and reporting
        - Integration with external services (Supabase, Google Sheets)
