...
class ComprehensiveReconciliationResponse(BaseModel):
    ...
    extra_amount_receivable_from_broker_variations: Optional[int] = Field(None, description="Variations in Extra Amount Receivable from Broker")
    ...
    cut_pay_amount_received_from_agent_variations: Optional[int] = Field(None, description="Variations in Cut Pay Amount Received From Agent")
    ...
    agent_extr_amount_variations: Optional[int] = Field(None, description="Variations in Agent_Extr_Amount")
    ...
    total_receivable_from_broker_include_18_gst_variations: Optional[int] = Field(None, description="Variations in Total Receivable from Broker Include 18% GST")
    ...
    actual_agent_po_percentage_alt_variations: Optional[int] = Field(None, description="Variations in Actual Agent PO%")
