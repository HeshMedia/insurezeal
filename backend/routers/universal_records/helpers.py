...
def transform_to_quarterly_headers(record: Dict[str, Any], insurer_name: str) -> Dict[str, Any]:
    ...
    quarterly_header_mapping = {
        ...
        'Agent Total PO Amount': record.get('Agent Total PO Amount', record.get('Total_Agent_PO_AMT', '')),
        ...
        'PO AMT Diff Broker': record.get('PO AMT Diff Broker', record.get('Broker PO AMT Diff', '')),
