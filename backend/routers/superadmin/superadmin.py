"""
SuperAdmin router for Insurezeal Backend API.

This module provides high-level administrative functionality for managing
core system entities including brokers, insurers, and admin child IDs.
All operations require superadmin privileges and are used for platform
configuration and management.

Key Features:
- Broker management (create, read, update, delete)
- Insurer management with comprehensive CRUD operations
- Admin child ID management and assignment
- Broker-insurer relationship management
- System-wide configuration capabilities
- Comprehensive logging for audit trails

Note:
All endpoints in this module require superadmin-level permissions and are
used for platform administration rather than day-to-day operations.
"""
