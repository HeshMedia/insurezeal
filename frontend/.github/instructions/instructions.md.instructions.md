...
9. we doing any changes to the code first explain if the approach mentioned in prompt is good will fix or do the job or not if its not good suggest a better approach and then implement the changes. 