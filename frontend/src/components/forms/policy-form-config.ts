...
export type PolicyFormFieldPath =
  | keyof SubmitPolicyPayload
  ...
  | "extracted_data.plan_type"
  | "extracted_data.customer_name"
  | "extracted_data.customer_phone_number"
  | "extracted_data.gross_premium"
  | "extracted_data.net_premium"
  | "extracted_data.od_premium"
  | "extracted_data.tp_premium"
  | "extracted_data.gst_amount"
...
export const policyFormFields: PolicyFormFieldConfig[] = [
  ...
  {
    key: "extracted_data.policy_number",
    label: "Policy Number",
    type: "text",
    section: "extracted",
    required: true,
  ...
  {
    key: "extracted_data.formatted_policy_number",
    label: "Formatted Policy Number",
    type: "text",
    section: "extracted",
    tag: "autofill",
  },
  {
    key: "extracted_data.major_categorisation",
    label: "Major Categorisation",
    type: "select",
    section: "extracted",
    tag: "autofill",
  },
  {
    key: "extracted_data.product_insurer_report",
    label: "Product Insurer Report",
    type: "text",
    section: "extracted",
    tag: "autofill",
  },
  ...
  {
    key: "extracted_data.customer_name",
    label: "Customer Name",
    type: "text",
    section: "extracted",
    required: true,
  ...
  {
    key: "extracted_data.customer_phone_number",
  ...
  // ✅ Vehicle Information
  {
    key: "extracted_data.registration_number",
  ...
  {
    key: "extracted_data.vehicle_variant",
  ...
  {
    key: "extracted_data.seating_capacity",
  ...
  {
    key: "extracted_data.business_type",
    label: "Business Type",
    type: "select",
    section: "vehicle",
    tag: "autofill",
  ...
  // ✅ Premium Information
  {
    key: "extracted_data.gross_premium",
    label: "Gross Premium",
    type: "number",
    section: "financial",
    required: true,
  ...
  {
    key: "extracted_data.net_premium",
    label: "Net Premium",
    type: "number",
    section: "financial",
    tag: "autofill",
  ...
  {
    key: "extracted_data.discount_percent",
    label: "Discount %",
    type: "number",
    section: "financial",
    tag: "autofill",
  ...
  {
    key: "admin_input.reporting_month",
  ...
  {
    key: "admin_input.agent_code",
    label: "Agent Code",
    type: "select",
    section: "admin",
  },
  {
    key: "admin_input.code_type",
    label: "Code Type",
    type: "select",
    section: "admin",
    options: [
  ...
  {
    key: "admin_input.payment_method",
    label: "Payment Method",
    type: "select",
    section: "admin",
    tag: "payment-method-dependent",
    options: [
  ...
  {
    key: "admin_input.agent_commission_given_percent",
